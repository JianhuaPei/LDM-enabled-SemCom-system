...
if __name__=='__main__':
    ...
    torch.save(generator.state_dict(), 'd:\\Python\\SemCom\saved_model\\generator_dc_model_of_Dog.pth')    
    torch.save(discriminator.state_dict(), 'd:\\Python\\SemCom\\saved_model\\discriminator_dc_model_of_Dog.pth') 